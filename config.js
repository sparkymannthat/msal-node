...
const msalConfig = {
    auth: {
        clientId: "APPLICATION-CLIENTID", // This is the ONLY mandatory field that you need to supply. AppRegistration
...
const apiConfig = {
    ...
    endpoint: "https://dev.azure.com/DEVOPSORG/setup k8/_apis/pipelines/28/runs?api-version=6.0-preview.1",
